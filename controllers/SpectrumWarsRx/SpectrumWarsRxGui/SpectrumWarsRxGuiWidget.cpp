...
SpectrumWarsRxGuiWidget::~SpectrumWarsRxGuiWidget()
{
}

void SpectrumWarsRxGuiWidget::setFrequency(double frequency)
{
  double delta = 0.05;
...
void SpectrumWarsRxGuiWidget::setBandwidth(double bandwidth)
{
  double delta = 0.05;
...
void SpectrumWarsRxGuiWidget::setGain(double gain)
{
  double delta = 0.05;
...
void SpectrumWarsRxGuiWidget::updateGradient()
{
