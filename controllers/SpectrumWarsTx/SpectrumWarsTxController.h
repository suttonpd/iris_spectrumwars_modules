/**
 * \file controllers/SpectrumWarsTx/SpectrumWarsTxController.h
 * \version 1.0
 *
 * \section COPYRIGHT
 *
...
#ifndef CONTROLLERS_SPECTRUMWARSTXCONTROLLER_H_
#define CONTROLLERS_SPECTRUMWARSTXCONTROLLER_H_

#include "boost/scoped_ptr.hpp"
#include "irisapi/Controller.h"
#include "SpectrumWarsTxGui/SpectrumWarsTxGui.h"

namespace iris
{

class SpectrumWarsTxController
  : public Controller
{
public:
  SpectrumWarsTxController();
...
private:
  ...
  boost::scoped_ptr<SpectrumWarsTxGui> gui_;
};

} // namespace iris

#endif // CONTROLLERS_SPECTRUMWARSTXCONTROLLER_H_
